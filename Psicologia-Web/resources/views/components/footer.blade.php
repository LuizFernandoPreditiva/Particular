<footer>
    ...
    <div class="social">
        <a href="https://www.instagram.com/luiz_fernando.11/">
            <img src="{{ asset('images/social_ig.svg') }}" alt="Instagram" title="Instagram"/>
        </a>
        <a href="https://www.linkedin.com/in/luiz-fernando-duarte-cabette-3a0ba7193/">
            <img src="{{ asset('images/social_linkedin.svg') }}" alt="LinkedIn" title="LinkedIn"/>
        </a>
        <a href="mailto:luiz.fernando@viannasempre.com.br">
            <img src="{{ asset('images/social_email.svg') }}" alt="E-mail" title="E-mail"/>
        </a>
        <a href="https://wa.me/+5532988097534">
            <img src="{{ asset('images/social_zap.svg') }}" alt="WhatsApp" title="WhatsApp"/>
        </a>
    </div>
